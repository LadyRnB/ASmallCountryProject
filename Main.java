...
public class Main {
	public static void main(String[] args) {
		...
		System.out
				.println("The number of cities we've created is: " + City.numberInstancesPublic + " (public counter)");// to
																														// access
																														// a
																														// public
																														// class
																														// variable
		System.out.println("The number of cities we've created is: " + City.getNbrInstances() + " (public counter)"); // to
																														// access
																														// a
																														// private
																														// class
		...
		System.out
				.println("The first City is: " + city1.getNameCity() + ", & it's located in " + city1.getNameCountry());
		System.out.println("The number of its inhabitants is: " + city1.getNbInhabitants());

		City city2 = new City("Marseille", "France", 1059000);
		System.out
				.println("The number of cities we've created is: " + City.numberInstancesPublic + " (public counter)");
		System.out.println("The number of cities we've created is: " + City.getNbrInstances() + " (private counter)");
		System.out.println(
				"The second City is: " + city2.getNameCity() + ", & it's located in " + city2.getNameCountry());
		...
		System.out
				.println("The third City is: " + city3.getNameCity() + ", & it's located in " + city3.getNameCountry());
		...
		System.out.println("The number of its inhabitants is: " + city2.getNbInhabitants() + ".\n");
		System.out.println(
				"The third City is: " + city3.getNameCity() + ", & it's located in " + city3.getNameCountry() + ".");
		System.out.println("The number of its inhabitants is: " + city3.getNbInhabitants() + ".\n");
